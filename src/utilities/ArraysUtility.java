...
public class ArraysUtility {
    ...
    //checks ıf the given int is contained in the given array.returns boolean.contains (int[], int)
    ...
    //checks ıf the given double is contained in the given array.returns boolean.contains (double[], double)
    ...
    //checks ıf the given char is contained in the given array.returns boolean.contains (char[], char)
    ...
    //checks ıf the given String is contained in the given array.returns boolean.contains (String[], String)
    public static boolean contains(String[] array, String element) {
        //                         {1,2,3,4}         6
        boolean result = false;

        for (String each : array) {
            if (each.equals(element)) { // if any arrays element is matching with thr given element ,it means the given element is contained in the array
                result = true;
            }
        }
        return result;
